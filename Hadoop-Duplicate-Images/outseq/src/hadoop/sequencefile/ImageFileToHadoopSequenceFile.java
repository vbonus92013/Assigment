...
public class ImageFileToHadoopSequenceFile {
	        ...
	        public static class ImageFileToHadoopSequenceFileMapper extends 
	        ...
	        public static void main(String[] args) throws Exception {
	            ...
	            String[] otherArgs = new GenericOptionsParser(conf, args).getRemainingArgs();
	                if (otherArgs.length != 2) {
	                        System.err.println("Usage: ImageFilesToHadoopSequenceFile <in Path for url file> <out pat for sequence file>");
	                        System.exit(2);
	                }
